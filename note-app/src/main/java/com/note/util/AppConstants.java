...
public class AppConstants {
	...
	public static final String PAGE_DASHBORD="dashboard";
	public static final String PARAM_USER_NAME = "name";
	public static final String PARAM_ERROR = "error";
	public static final String MESSAGE_ERROR = "MSG_ERROR";
	...
	public static final String TRANSACTION_SUCCESSFUL = "Trans";
	...
	public static final String NOTE_DETAILS = "notes";
	public static final String PARAM_NOTE_UPDATED_DATE = "updatedOn";
	public static final String PARAM_NOTE_CREATED_DATE = "createdOn";
